...
public class PresidenteDeMesa extends Persona{
    ...
    protected final static PresidenteDeMesa OBJETO_INVALIDO = new PresidenteDeMesa();

    private static Set<PresidenteDeMesa> listaObjetos = new HashSet<>();
    ...
    protected static PresidenteDeMesa nuevo(){

        //Crear un objeto a devolver
        PresidenteDeMesa objetoDevolver = PresidenteDeMesa.OBJETO_INVALIDO;

        //Crear un nuevo objeto
        PresidenteDeMesa objetoNuevo = new PresidenteDeMesa();
    ...
    private static Estado addNewObjeto(Object objetoActual){
        ...
        if(objetoActual.getClass() == PresidenteDeMesa.class){

            //Obtener el objeto requerido
            PresidenteDeMesa objetoAgregar = (PresidenteDeMesa)objetoActual;
